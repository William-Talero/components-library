...
describe('Accordion Component', () => {
  it('Should render Section Accordion', async () => {
    act(() => {
      render(
        <SectionAccordion title="Test Title" content="Test Content">
          <Accordion>
            <AccordionTab header="Placeholder">
              <Text3>Section Accordion Test</Text3>
            </AccordionTab>
          </Accordion>
        </SectionAccordion>
      );
  ...
  it('Should render Section Accordion', async () => {
    act(() => {
      render(
        <SectionAccordion
          ...
          titleClassName="title-test-class"
          descriptionClassName="description-test-class"
        >
          <Accordion>
            <AccordionTab header="Placeholder">
              <Text3>Section Accordion Test</Text3>
    ...
    const elementWithTitleClass =
      document.getElementsByClassName('title-test-class')[0];
    const elementWithDescriptionClass = document.getElementsByClassName(
