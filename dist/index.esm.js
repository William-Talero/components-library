...
var ButtonWithIcon = function (data) {
    ...
    return (React.createElement(Button, __assign({}, data),
        React.createElement(Icon, { "$name": icon, "$w": "20%" }),
        React.createElement(ButtonContent, null, children),
        $size == "lg" && React.createElement(Icon, { "$name": icon, "$w": "20%" })));
};
var Button = function (data) {
    var children = data.children;
    return React.createElement(ButtonElement, __assign({}, data), children);
};
var OrangeButton = function (data) {
    var children = data.children;
    return React.createElement(OrangeButtonElement, __assign({}, data), children);
};
